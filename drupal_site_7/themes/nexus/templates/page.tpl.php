...
if($node->type =='section_page'): ?>
  ...
  <div id="fixedbar">
    ...
    <div class="fixedleft_2"><a href="http://www.livingstoneonline.org"><img class="fixedheaderlogo" src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/lo-sm-30.jpg'; ?>"/></a>  </div>
    </div>
