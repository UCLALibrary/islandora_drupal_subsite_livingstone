...
<div class="l-page">
  ...
  <!-- Moved breadcrumb outside l-content -kmd 
	  Removed breadcrumb because Adrian's sidebar duplicated functionality -kmd
  -->
  <?php // print $breadcrumb; ?>
  
  <!-- moved sidebar first above content. On mobile/all screens this should appear first. --kmd -->
